    ...
    <>
      <section className="py-24">
        <div className="container max-w-3xl">
          ...
          <p className="text-m text-center pt-2">I created this portfolio site to serve as a one-stop-shop where you can find my <a className="underline hover:underline-offset-2" href="/files/resume.pdf" target="_blank" rel="noopener noreferrer">CV</a>, see some examples of my <Link className="underline hover:underline-offset-2" href="/projects">work</Link>, and learn a bit <Link className="underline hover:underline-offset-2" href="/about">about</Link> the man behind the monitor.</p>
